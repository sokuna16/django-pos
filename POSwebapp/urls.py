...
urlpatterns = [
    ...
    path('categories/', views.brand_list, name='brand_list'),
    path('products/add/', views.add_product, name='add_product'),
    path('categories/add/', views.add_brand, name='add_brand'),
    path('categories/edit/<int:brand_id>/', views.edit_brand, name='edit_brand'),
